...
## ✨ Introduction
### VTL
> Video Tracing and Tampering Localization (VTL). A novel framework to detect fake video by tracing the source video of fake video. 1) Training hash centers as HCs. 2) Finding index of source video from HCs. 3) Masking the different between fake video and source video as a result of comparison.
<div align="center">
...
> Same person with different scenes. Three gifs in first line is source video, and you can download full 16 minutes videos of source video and fake video by follows link.
...
> The first gif of boat is source video, and remaining five video generated by different methods.
