...
from data.inpainting_dataset import get_inpainting_dataloader
...
def train_model(Hash_center, sym_net, model_prefix, dataset, input_conf, hash_bit,
                ...
                lr_base=0.1, lr_factor=0.1, lr_steps=[4000, 8000],
                end_epoch=1000, distributed=False, data_type=-1,
    ...
    # else:
    #     net.net = torch.nn.DataParallel(net.net).cuda(device=1)
